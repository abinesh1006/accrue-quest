    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/" element={currentPoints > 0 ? <QuizContainer currentPoints={currentPoints} onPointsUpdate={handlePointsUpdate} /> : <Navigate to="/point-exhausted" />} />
                <Route path="/point-exhausted" element={<PointExhaustedComponent />} />
                <Route path="/grid-click" element={<GridClickComponent currentPoints={currentPoints} onPointsUpdate={handlePointsUpdate} />} />
